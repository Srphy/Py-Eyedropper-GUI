...
while True:
    ...
    tx1 = cv2.putText(im, 'Q to copy rgb value, S to copy hex value', (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.7, fontColor, 1, cv2.LINE_AA)
    tx1_2 = cv2.putText(im, 'D to copy both, Esc to shut down', (10, 55), cv2.FONT_HERSHEY_SIMPLEX, 0.7, fontColor, 1, cv2.LINE_AA)
